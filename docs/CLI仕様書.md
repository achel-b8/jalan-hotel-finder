...
運用注記（2026-03-04更新）:
- `SML_013508`（2026-02-24観測）と `SML_101402`（2026-03-04観測）は恒常的に「エラー画面（アクセス集中文言）」を返すため、v1では固定除外リストから検索対象外にする。
...
| 除外SMLコード | `SML_013508`, `SML_101402` | 2026-02-24/2026-03-04観測で恒常的にエラー画面を返すため固定除外 |
